...
const CompresionMonitor = {
    recursos: [
        ...
        { nombre: 'index_grande.html', tipo: 'HTML', icono: '📄' },
        { nombre: 'styles.css',       tipo: 'CSS',   icono: '🎨' },
        { nombre: 'styles.min.css',   tipo: 'CSS',   icono: '🎨' },
        { nombre: 'app.js',           tipo: 'JS',    icono: '⚙️' },
        { nombre: 'app.min.js',       tipo: 'JS',    icono: '⚙️' },
        { nombre: 'data.json',        tipo: 'JSON',  icono: '📊' },
        { nombre: 'image.svg',        tipo: 'SVG',   icono: '🖼️' },
        { nombre: 'feed.xml',         tipo: 'XML',   icono: '📰' },
...
const DNSInfo = {
    ...
    registros: [
        ...
        { tipo: 'CNAME', nombre: 'ftp',     valor: 'www'                },
        { tipo: 'MX',    nombre: '@',       valor: '10 mail'            },
        { tipo: 'AAAA',  nombre: 'www',     valor: '2001:db8:50::80'     },
        { tipo: 'AAAA',  nombre: 'mail',    valor: '2001:db8:50::25'     },
        { tipo: 'AAAA',  nombre: 'ns1',     valor: '2001:db8:50::10'     },
        { tipo: 'AAAA',  nombre: 'ns2',     valor: '2001:db8:50::11'     },
